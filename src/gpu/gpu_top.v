...
module gpu_top(
    ...
    GPU_Pipeline_Reg #(217) id_ex_reg(
        .clk(clk),
        .rst(rst),
    ...
    GPU_Pipeline_Reg #(64) id_ex_rs3_reg(
        .clk(clk),
        .rst(rst),
        .stall(1'b0),
        .flush(flush_execute),
    ...
    GPU_Pipeline_Reg #(140) ex_mem_reg(
        .clk(clk),
        .rst(rst),
        .stall(1'b0),
        .flush(1'b0),
...
*/
    ...
    GPU_Pipeline_Reg #(139) mem_wb_reg(
        .clk(clk),
        .rst(rst),
        .stall(1'b0),
        .flush(1'b0),
